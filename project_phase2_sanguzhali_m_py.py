# -*- coding: utf-8 -*-
"""project_phase2_sanguzhali_m.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1fRKuEMUnQK9oY7mwi_8YmPp_Whgx3_nV
"""
...
try:
    ...
    # If the file isn't found, try looking in the content folder
    try:
        df = pd.read_csv('/content/Bank Customer Churn Prediction.csv', sep=';')
    except FileNotFoundError:
        print("File not found. Make sure it's uploaded and in the correct location.")
